...
from settings import BOOTSTRAP_SERVERS, CONSUME_TOPIC_RIDES_CSV,CONSUME_TOPIC_FHVH_RIDES_CSV,CONSUME_TOPIC_GREEN_RIDES_CSV
...
if __name__ == '__main__':
    ...
    csv_consumer = CSVConsumer(props=config)

    # topic = CONSUME_TOPIC_RIDES_CSV
    # csv_consumer.consume_from_kafka(topics=[topic])

    # topic = CONSUME_TOPIC_GREEN_RIDES_CSV
    # csv_consumer.consume_from_kafka(topics=[topic])

    # topic = CONSUME_TOPIC_FHVH_RIDES_CSV
    # csv_consumer.consume_from_kafka(topics=[topic])
